                   ...
                   <div class="col-12">
                       <div class="card">
                           <div class="card-body p-4">
                               <form accept="{{ route('supplier.update', $supplier->id) }}" method="POST">
                                   @csrf
                                   @method('PUT')
                                   <div class="row">
                                   ...
                                   <div class="row">
                                       <div class="col-md-6 mb-3">
                                           ...
                                           <input type="number" class="form-control" id="supplierPhone"
                                               ...
                                               name="phone" placeholder="09xxxxxxxxx" value="{{ old('phone', $supplier->phone) }}"
                                               required>
                                   ...
                                   <div class="mb-3">
                                       ...
                                       <textarea class="form-control @error('supplierAddress') is-invalid @enderror" id="supplierAddress"
                                           name="address" rows="4" placeholder="Enter supplier address">{{ old('address', $supplier->address) }}</textarea>
